...
export default function HeroSection() {
  ...
  return (
    <>
      ...
      <section className="px-4 sm:px-6 lg:px-8 pt-0 pb-8">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <div className="relative flex min-h-[520px] flex-col justify-end px-8 sm:px-12 lg:px-16 pb-12 lg:pb-16">
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="container-bni">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            {/* Left column: heading + video placeholder */}
            <motion.div
            ...
            >
              <h2 className="text-4xl font-bold leading-tight text-dark lg:text-5xl">
                Join <span className="font-black">BNI®</span>, the world's largest
                and most successful{' '}
            ...
            {/* Right column: description + stats mosaic */}
            <motion.div
            ...
            >
              ...
              {/* Stats mosaic */}
              <div ref={statsRef} className="rounded-2xl bg-[#EFEFEF] p-3">
                {/* Row 1 */}
                <div className="grid grid-cols-2">
                  <StatCell>
                    ...
                    <StatSub>As of 31st December, 2025</StatSub>
                  </StatCell>
                  <StatCell>
                    <StatValue>
                ...
                {/* Centre elevated card */}
                <div className="relative z-10 mx-2 -my-2 rounded-2xl bg-white px-6 py-8 text-center shadow-2xl">
                  <p className="text-5xl font-black text-primary">
                    {inView
                      ? <CountUp end={26.5} decimals={1} duration={2.5} prefix="$" suffix="B" />
                      : '$0B'}
                  </p>
                  <p className="mt-1.5 text-sm font-semibold text-dark">Member Generated Business</p>
                  <p className="mt-0.5 text-[11px] text-gray-400">Last 12 Months*</p>
                </div>
